...
const Proyectos = () => {
  return (
    <section className='flex flex-col items-center gap-4 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-background to-default-400 rounded-md p-4'>
       <h2>Proyectos</h2>
